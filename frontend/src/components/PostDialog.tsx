...
import { INSERT_POST } from '../query/query';
...
const PostDialog: React.FC<PostDialogProps> = ({ onClose, open, disableBackdropClick, profile, name, userId, refetch}) => {
  if (!open) return null;
  ...
  return (
    <div className="post-dialog-overlay" onClick={handleClickOutside}>
      <div className="post-dialog-content">
        ...
        {/* <input type="text" className='postText' placeholder={placeholder} value={contentText} onChange={ (e) => setContentText(e.target.value)}/> */}
